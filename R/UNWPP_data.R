...
UNWPP_data <-
  ...
  # Define file paths
  fertility_file <- paste0(dir, "/WPP2024_Fertility_by_Age1.csv")
  male_lifetable_file <- paste0(dir, "WPP2024_Life_Table_Complete_Medium_Male_1950-2023.csv")
  female_lifetable_file <- paste0(dir, "WPP2024_Life_Table_Complete_Medium_Female_1950-2023.csv")
  ...
  WPP2024_male_lifetable <- fread(male_lifetable_file) %>% data.frame()
  WPP2024_female_lifetable <- fread(female_lifetable_file) %>% data.frame()
  ...
  if (sex == "Male") {
    ...
    fertility_data <- fread(fertility_file) %>% data.frame()
...
UNWPP_pop <-
  ...
  WPP2024_pop <- 
    fread(paste0(dir, "WPP2024_Population1JanuaryBySingleAgeSex_Medium_1950-2023.csv")) %>% 
    data.frame()
